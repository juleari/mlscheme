...
(print (day-of-week 17 5 2016))
(print (day-of-week 10 4 2016))
(print (day-of-week 29 3 2016))
(print (day-of-week 20 4 2016))
(print (0->1 (list 0 2 7 0 5)))
(print (0->1 (list 0 1 0 1 0)))
(print (count 1 (list 1 2 3 1)))
(print (count 0 (list 1 2 3 4)))
(print (count 5 (list 1 2 3 4 5 5 5)))
(print (fact 5))
(print (fact 10))
(print (sum 1 2 3 4))
(print (apply sum (list 5 6 7 8 9 10)))
(print (replace zero? (lambda (x) (+ x 1)) (list 0 1 2 3 0)))
(print (replace odd? (lambda (x) (* x 2)) (list 1 2 3 4 5 6)))
(print (replace (lambda (x) (> 0 x)) exp (list 0 1 -1 2 -2 3 -3)))
(print (replicate "a" 5))
(print (replicate (list "a" "b") 3))
(print (replicate "a" 0))
(print (cycle (list 0 1) 3))
(print (cycle (list 'a 'b 'c) 5))
(print (cycle (quote ()) 0))
(print (and-fold #f #f #f))
(print (and-fold #f #f #t))
(print (and-fold #f #t #t))
(print (and-fold #t #t #t))
(print (and-fold))
(print (0? 0))
(print (0? 1))
(print (nil? 0))
...
(define (insertion-sort pred? xs)
         ...
         (helper '() xs))
(print (selection-sort (lambda (x y) (<= x y)) (list 9 6 2 4 3 5 7 1 8 0)))
(print (insertion-sort (lambda (x y) (<= x y)) (list 9 6 2 4 3 5 7 1 8 0)))
(print (replicate str 8))
(print (my-gcd 3542 2464))
(print (my-lcm 3 4))
(print (prime? 11))
(print (prime? 12))
(print (bisection cos -3.0 0.0 0.001))
(print (round (newton (lambda (x) (** x 2)) (lambda (x) (* 2 x)) 1.0 1e-08)))
(print (round (newton (lambda (x) (+ (+ (** x 2) (* 4 x)) 4)) (lambda (x) (+ (* 2 x) 4)) 5.0 1e-08)))
(print (round (golden (lambda (x) (** x 2)) -2.0 2.0 1e-08)))
(print (round (golden (lambda (x) (+ (+ (** x 2) (* 4 x)) 4)) -5.0 5.0 1e-06)))
(print (+ 5 6))
(print (not 8))
(print (range 0 11 3))
(print (flatten (list (list 1) 2 (list 3 (list 4 5) (list 6 (list 7 8))) 9)))
(print (element? 1 (list 3 2 1)))
(print (element? 4 (list 3 2 1)))
(print (filter odd? (apply range (list 0 10 1))))
(print (filter (lambda (x) (= (% x 3) 0)) (apply range (list 0 13 1))))
(print (fibonacci 99))
(print (fibonacci 100))
