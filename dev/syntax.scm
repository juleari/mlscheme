(define tokens '(#(tag-sym #(1 1) "fibonacci")
                 #(tag-num #(1 11) 0)
                 #(tag-to #(1 13) "<-")
                 #(tag-num #(1 16) 1)
                 #(tag-sym #(2 1) "fibonacci")
                 #(tag-num #(2 11) 1)
                 #(tag-to #(2 13) "<-")
                 #(tag-num #(2 16) 1)
                 #(tag-sym #(3 1) "fibonacci")
                 #(tag-sym #(3 11) "n")
                 #(tag-to #(3 13) "<-")
                 #(tag-sym #(3 16) "fibonacci")
                 #(tag-lprn #(3 26) #\()
                 #(tag-sym #(3 27) "n")
                 #(tag-mns #(3 29) "-")
                 #(tag-num #(3 31) 1)
                 ...
                 #(tag-rprn #(3 52) #\))
                 #(tag-kw #(5 1) "memo")
                 #(tag-sym #(5 6) "fibonacci")
                 #(tag-sym #(7 1) "fibonacci")
                 #(tag-num #(7 11) 99)
                 #(tag-sym #(8 1) "fibonacci")
                 #(tag-num #(8 11) 100)))
